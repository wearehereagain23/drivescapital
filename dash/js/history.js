...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function executeIdentityAndHistorySync() {
        ...
        try {
            ...
            const accountFetch = await fetch("https://api-v2-neon-alpha.vercel.app/api/bank/data", {
                method: "GET",
                headers: {
            ...
            const historyFetch = await fetch("https://api-v2-neon-alpha.vercel.app/api/bank/history", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${sessionTokenSignature}`
