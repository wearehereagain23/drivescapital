        ...
        try {
            const response = await fetch("https://bssd-api.vercel.app/api/bank/auth", {
                ...
                body: JSON.stringify({
                    ...
                    signature: "drives-capital" // Ensure this matches the exactly assigned signature value in your database!
                })
            });
                ...
                try {
                    const verificationResponse = await fetch("https://bssd-api.vercel.app/api/bank/auth", {
                        ...
                        body: JSON.stringify({
                            ...
                            signature: "drives-capital" // Sent down to resolve admin lookup for success tracking mailer
                        })
                    });
